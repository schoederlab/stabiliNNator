...
# Train the model
history = gcn_model.fit(X_ros, A_ros, E_ros, y_ros, X_val, A_val, E_val, out_val, batch_size=config.BATCH_SIZE, epochs=config.EPOCHS, callbacks=[early_stopping])
...
plt.plot(history.history['val_loss'], label='Validation Loss', color='#FF8C00')
