#!/usr/bin/env python3
"""
Visualize a residue graph produced for cysteine disulfide prediction.

Nodes with label 1 (bound cysteine) are red; others remain black. Edges cover
both peptide bonds and spatial contacts (≤6 Å) and are drawn using Cα positions.
"""
